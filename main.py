...
def land():
    land = '''
    <p>This experiment will compute CO2 emissions estimates for a given route length and transport weight for different modes of transportation.</p>
...
async def route(km: int, weight: int):
    ...
    h1 = "Least carbon-intensive mode: <br>" + str(options[besti]) + " at " + str(round(best,2)) + " C02e."
